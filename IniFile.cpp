...
bool IniFile::checkFile(void) const
{
	if (!_file)
	{
		_error = errorFileNotOpen;
...
bool IniFile::setSection(const char *section)const
{
	if (!checkFile())
		return (false);
...
bool IniFile::setValue(const char *key,
					   char *value,
					   size_t vLen,
					   bool isHex) const
{
...
bool IniFile::setValue(const char *key, char *value)
{
	if (!checkFile())
		return false;
...
bool IniFile::setValue(const char *key, uint8_t value)
{
	if (!checkFile())
		return false;
...
bool IniFile::setValue(const char *key, uint16_t value)
{
	if (!checkFile())
		return false;
...
bool IniFile::setValue(const char *key, float value)
{
	if (!checkFile())
		return false;
...
bool IniFile::getHexValue(const char *section,
						  const char *key,
						  char *buffer,
						  size_t len,
						  char *value,
